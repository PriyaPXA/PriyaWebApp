...
function renderProperty(p) {
  ...
  <span style="box-sizing: border-box;">${p.flw}</span>
  <span style="box-sizing: border-box;" class="hdp__qf5kuj-5 hrNWfo">&nbsp;flowers</span></span>
  ...
  <span style="box-sizing: border-box;">${p.bq}</span><span style="box-sizing: border-box;" class="hdp__qf5kuj-5 hrNWfo">&nbsp;boquets</span></span>
  </button>
  <span style="box-sizing: border-box; border-style: solid; border-width: 0px 1px 0px 0px; border-color: #d1d1d5; margin-right: 8px; padding-right: 8px;" class="hdp__qf5kuj-6 iDzikP"></span>
  <span style="box-sizing: border-box; font-size: 15px; line-height: 1.5;" class="hdp__qf5kuj-4 jGniAU">
  </span>
  ...
  <span style="font-size: 12.0pt; font-family: 'Open Sans', sans-serif; color: #2a2a33;">${p.description} </span> </p>
    ...
    <ul>
    <li > <a>Previous Ownership and Pricing Trends</a></li>
    <li > <a>Monthly Operating Costs</a></li>
    <li > <a>Potential Business Grants or Assistance</a></li>
    <li > <a>Projected Monthly Sales and Revenue</a></li>
    <li > <a>Nearby Competing Florists</a></li>
    <li > <a>Similar Flower Shops in the Region</a></li>
    <li > <a>Demographics and Buying Behavior in Maplewood Square</a></li>
    <li > <a>Local Business Regulations and Licenses</a></li>
    </ul> 
   </td>
    </tr>
    </table>
